...
class GreetingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SayHello = channel.unary_unary(
                '/greet.GreetingService/SayHello',
...
def add_GreetingServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'greet.GreetingService', rpc_method_handlers)
...
class GreetingService(object):
    ...
    def SayHello(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/greet.GreetingService/SayHello',
